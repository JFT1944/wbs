...
<script>
document.getElementById('originalArticle').addEventListener('mouseenter', () => {
document.querySelector('#originalArticle').style.filter = 'brightness(0.5)';

})
document.getElementById('originalArticle').addEventListener('mouseleave', () => {
    document.querySelector('#originalArticle').style.filter = 'brightness(1)';
})
</script>
</body>
</html>